...
export {
  actor_schema_default as actorSchema,
  dataset_schema_default as datasetSchema,
  ...
  input_schema_default as inputSchema,
  key_value_store_schema_default as keyValueStoreSchema,
  output_schema_default as outputSchema
};
