...
var GITHUB_GIST_URL_REGEX = new RegExp(
...
var META_ORIGINS = {
  ...
  CI: "CI",
  // Job started from a CI/CD pipeline (e.g. GitHub Actions)
  MCP: "MCP",
  // Job started trough apify client triggered from apify-mcp-server
  APIFY_AI: "APIFY_AI"
  // Job started from Apify AI chat (via MCP server)
};
var DOCKER_LABELS = {
...
var COMMA_SEPARATED_LIST_ENV_VARS = [ACTOR_ENV_VARS.BUILD_TAGS];
var JSON_ENCODED_ENV_VARS = [ACTOR_ENV_VARS.STORAGES_JSON];
...
var WEBHOOK_ALLOWED_PAYLOAD_VARIABLES = /* @__PURE__ */ new Set(["userId", "createdAt", "eventType", "eventData", "resource"]);
